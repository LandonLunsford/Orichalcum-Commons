package orichalcum.animation.bitmap
{
	...
	public class BitmapAnimation extends Bitmap
	{
		...
		private var _timeline:BitmapAnimationTimeline;
		...
		public function get timeline():BitmapAnimationTimeline { return _timeline; }
		...
		public function set timeline(timeline:BitmapAnimationTimeline):void
		{
			_timeline = timeline;
